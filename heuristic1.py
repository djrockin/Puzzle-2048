...
class game:
    ...
    def dummy(self,grid,chance,depth):
        if depth==0:
            return eval1(grid)
        if chance==0:
            score1=float('inf')
            ...
            for ele in arr:
                ...
                if t<9:
                    ...
                    grid[i][j]=4
                score1=self.dummy(grid,1-chance,depth-1)
                if score<score1:
                    score1=score
                    pos=(i,j)
                grid[i][j]=0
            ...
            for i in range(4):
                if i==0:
                   p,s,grid1=self.move_down1(grid)
                           score1=score
